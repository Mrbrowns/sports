...
@ConfigurationProperties(prefix="SportsProperties")
public class SportsProperties {
    ...
    public static class Mail {
        ...
        private String from = "jhipsterGradleSampleApplication@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "体育公众号 API";

        private String description = "体育公众号 API 文档";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jhipsterGradleSampleApplication";
